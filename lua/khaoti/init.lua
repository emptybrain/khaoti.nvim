...
local theme = lush(function(injected_functions)
        ...
        return {
            ...
            --
            IncSearch {  bg = default_colors.black, fg = default_colors.lime, italic = true, underline = true }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
            Search { bg = default_colors.black, fg = default_colors.lime, bold = true, italic = true, underline = true }, -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
            Substitute { fg = default_colors.dark_grey.lighten(50), bg = default_colors.red3 }, -- |:substitute| replacement text highlighting
            --
            MatchParen { bg = default_colors.black, fg = default_colors.red2, bold = true, underline = true }, -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
            ...
            IndentBlanklineContextChar { fg = default_colors.black2 },
